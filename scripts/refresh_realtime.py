...
Usage:
    python scripts/refresh_realtime.py                # all configured feeds
    python scripts/refresh_realtime.py --feeds comps  # one feed
"""
...
from presale.extract.realtime import refresh
