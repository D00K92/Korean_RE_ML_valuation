...
def test_reference_source_resolvable():
    # reference is GCS-backed at runtime; offline the suite resolves the committed
    # fixture via REFERENCE_DIR (see tests/conftest.py)
    assert reference_path("legal_dong_codes.txt").exists()
